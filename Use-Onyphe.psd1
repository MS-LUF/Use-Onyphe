...
AliasesToExport = @('Export-Onyphe','Get-Onyphe','Get-OnypheAlert','Get-OnypheFromCSV','Search-Onyphe','Set-OnypheAlert','Update-OnypheLocalData','Export-OnypheBulkSimple','Export-OnypheBulkSummary')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'v1.3 : update bulk APIs, add simple best APIs'
