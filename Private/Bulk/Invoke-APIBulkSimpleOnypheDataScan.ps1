	...
	<#
		 ...
		 Set APIKEY as global variable.
		  ...
		  C:\PS> Invoke-APIBulkSimpleOnypheDataScan -FilePath .\listips.txt -OutFile .\result.json

		  .EXAMPLE
		  export all datascan info available as JSON for all ips contained in listips.txt and set the API Key
		  C:\PS> Invoke-APIBulkSimpleOnypheDataScan -FilePath .\listips.txt -APIKey "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" -OutFile .\result.json
	#>
		[cmdletbinding()]
		Param (
